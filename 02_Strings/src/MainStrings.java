...
public class MainStrings {
	public static void main(String[] args) {
        ...
        String mayusculas = frase.toUpperCase(); //frase.toUpperCase sirve para poner en mayúscula la frase declarada en la variable
        ...
        String subcadena3 = frase.substring(0,9).substring(0,6); //se i9mprimirá el ultimo substring
