...
public class EjercicioCoche3Corregido {
	...
	public static void main(String[] args) {
		// se ponen variables para no perder los datos que devuelve la función, cada vez
	...
	public static void recorrerArray(ArrayList<Coche> listaCoches) { // la listaCoches es una variable(referencia) que
																		...
																		// que ponemos al invocar esta función
		int i = 1;
		for (Coche c : listaCoches) { // este for each va apuntando a cada objeto guardado por orden de posición
			mostrarCoche(c, i);
			i++;
		}
	}
