...
public class Persona {
	// Una clase Java en cualquier lenguaje tiene atributos y tiene métodos
	...
	// este el constructor con todos los parámetros
	public Persona(String nombre, double peso, int edad, String profesion) {
		super(); // En Java existe la herencia , y esto está invocando al padre de este objeto
