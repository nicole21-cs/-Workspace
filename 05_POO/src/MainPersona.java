...
public class MainPersona {
	...
	public static void main(String[] args) {
		...
		p1.edad = 29;
		p1.peso = 58.5;
		p1.profesion = "Mecánico";
		// Persona p7 = p1 ; aquí se "cambia" de referencia y no pierdes al objeto , en
		// este caso a persona
		// Persona p1 = new Persona(); //aquí se está creando un nuevo objeto y se
		// perdería el anterior objeto creado

		System.out.println(p1.nombre);
		System.out.println(p1.edad);
		System.out.println(p1.peso);
		System.out.println(p1.profesion);
		System.out.println(p1); // esto imprime la dirreción donde se encunetra el objeto
