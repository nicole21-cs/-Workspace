...
public class MainArrays {
	...
	public static void main(String[] args) {
		//Las listas Java tiene listas dinámicas y listas estáticas
		//Listas estáticas
		int[] arrayNumeros = new int[10]; //[10] Esto es las posiciones que tiene el arryay
		arrayNumeros[0] = 23; //para que guarde el número
        System.out.println(arrayNumeros[0]);
        System.out.println(arrayNumeros[1]);
        System.out.println(arrayNumeros.length); //es un método de la clase array; la longitud del array
       ...
       //System.out.println("esto NO se ejecuta después");
        System.out.println(arrayNumeros[8]);
        System.out.println("Esto se ejecutará después");
        
        //Listas dinámicas -- Son objetos en JAVA ,por ello tiene un estado y unos atributos
        //hay que utilizar la clase array list
        ArrayList<String> listaStrings = new ArrayList<String>();
        listaStrings.add(0, "Harry"); // primer valor es la posición del array.El segundo valor que contendrá el ARRAY
        listaStrings.add(1, "Ermion");
        boolean a = listaStrings.add("Ron"); //se hace asi y ya se añade directamente a la siguiente posicion
