...
public class MainAvion {
	...
	public static void main(String[] args) {
		...
		p4.setNombre(" Luna Ferrán");  //(new ArrayList<Maleta>(); esto se puede poner para que no tenga maleta 
		...
		System.out.println("El número total de pasajeros es : ");
		System.out.println(av.contarPasajeros());
		
		System.out.println("El número de maletas es : ");
